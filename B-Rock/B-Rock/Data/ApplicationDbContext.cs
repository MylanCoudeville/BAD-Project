    ...
    public class ApplicationDbContext : IdentityDbContext<B_RockUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Concert>().HasData(
                ...
                new Concert() { Id = 5, Title = "Life and Death", PerformedBy = "The great themes of life", Location = "Festival Centre Kreuzkirche", City = "Bonn", Country = "DE", DateAndTime = new DateTime(2023, 9, 2, 16, 00, 00), UniqueURL = "Life-And-Death.jpg", ExternLink = "https://b-rock.org/project/life-and-death/", Price = 65 },
                new Concert() { Id = 6, Title = "The Listeners Academy", PerformedBy = "Alexander Melnikov & B'Rock", Location = "University of Bonn, Aula", City = "Bonn", Country = "DE", DateAndTime = new DateTime(2023, 9, 8, 19, 30, 00), UniqueURL = "The-Listeners-Academy.jpg", ExternLink = "https://b-rock.org/project/the-listeners-academy-2/", Price = 50.50 },
                new Concert() { Id = 7, Title = "The Listeners Academy", PerformedBy = "Alexander Melnikov & B'Rock", Location = "University of Bonn, Aula", City = "Berlin", Country = "DE", DateAndTime = new DateTime(2023, 9, 10, 11, 00, 00), UniqueURL = "The-Listeners-Academy.jpg", ExternLink = "https://b-rock.org/project/the-listeners-academy-2/", Price = 30.50 }
                );
        }
